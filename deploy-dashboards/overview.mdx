...
To deploy your dashboard, you will need to take the following the steps laid out below:
...
2. [Frontend Setup](/deploy-dashboards/frontend-setup) - These frontend setup allows you to embed and deploy your dashboards within your product.
