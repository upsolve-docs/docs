...
The endpoint is a "refresh" endpoint that consumes the payload and issues a 1h short-lived JWT. This endpoint should be hit every time you re-authorize the user in your app. 
