...
Returns the same values as [bitwise_right_shift](#bitwise_right_shift) when shifting by less than
...
See also [bitwise_and_agg](/sql/functions/aggregate#bitwise-and-agg) and [bitwise_or_agg](/sql/functions/aggregate#bitwise-or-agg).
