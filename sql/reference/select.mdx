...
For description of table functions usage, see [table functions](/sql/functions/table).
...
supported statements, and examples in [routines](/sql/sql/routines/introduction).
...
- The window frame, which specifies a sliding window of rows to be processed
  ...
  called over the window, similarly to window functions.
