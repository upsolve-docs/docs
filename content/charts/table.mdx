...
Example: formatting number columns

<Frame>
  <img
    className="block dark:hidden"
    src="/images/build-your-first-dashboard/light/format-table.png"
  />
  <img
    className="hidden dark:block"
    src="/images/build-your-first-dashboard/dark/format-table.png"
  />
