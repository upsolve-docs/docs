...
You can use the point-and-click interface to edit [a newly created chart](/embedded-bi/charts/create-chart) or an existing chart.
...
<AccordionGroup>
  <Accordion title="1. Select raw table(s)">
    ...
    The list of available raw table(s) is generated after the [data connection](/embedded-bi/data-connection/data-connection) is set up and metadata is computed.
...
<Accordion title="3. Build chart">
  ...
  <Accordion title="4. Configure filters">
    It is now possible to configure chart-level filters, for columns you expect users to interact with. For a more comprehensive overview, check out our [in-depth filtering guide](/embedded-bi/filters/filters-in-depth).
...
[**Chart Edit**](/embedded-bi/charts/point-and-click-interface#building-a-chart-via-point-and-click) screen mentioned above.
