...
You can use the point-and-click interface to edit [a newly created dashboard](/embedded-bi/dashboards/create-dashboard) or an existing dashboard.
...
[**Dashboard Edit**](/embedded-bi/dashboards/point-and-click-interface#building-a-dashboard-via-point-and-click) screen mentioned above.
