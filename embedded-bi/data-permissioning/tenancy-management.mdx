...
Tenants can be registered via the [Backend Setup](/embedded-bi/deploy-dashboards/backend-setup) endpoint or created manually through the interface.
...
You can register a tenant by following the [Backend Setup](/embedded-bi/deploy-dashboards/backend-setup) instructions.
...
* If you have completed the [Backend Setup](/embedded-bi/deploy-dashboards/backend-setup), you can view the dashboard as one of your customers.
