...
When you are in **Edit Dashboard** mode (navigatble via the side navigation bar when you are previewing a dashboard), 
...
### Add Filter
Adding filters allow you and your end-users to be able to interact with the dashboard in an intuitive manner. When you click **Add filter**, 
a right-hand-side panel will slide out and you can configure new filter accordingly. YOu can configure the type and subtype of filter, 
and the targeted charts the filter would have effect on.

![dashboard-add-filter](/images/dashboards/dashboard-add-filter.png)
