...
<Accordion title="2. Prepare data">
  ...
  **Run query** to execute the code. You can set a specific **Query limit** to
  constraint the length of the resultant table output.
...
<Accordion title="3. Build chart">
  ...
  columns for the charting. See [Possible
  Configuration](/charts/possible-configuration) for settings to tailor your
